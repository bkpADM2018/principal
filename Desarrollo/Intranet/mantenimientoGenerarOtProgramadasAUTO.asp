...
call executeProcedureDb(DBSITE_SQL_INTRA, rsList, "TBLSMOTEXECUTIONS_GET_BY_IDOTGENERATED", 0)
...
call executeProcedureDb(DBSITE_SQL_INTRA, rs, "TBLSMORDER_INS", SM_nroOrder & "||" & SM_dsOrder & "||" & SM_idDivision & "||" & SM_idActiveEquipment & "||" & pScheduledDate & "||" & SM_maintenanceType & "||" & SM_cdState & "||" & SM_cdApplicant & "||" & SM_orderType & "||" & SM_idResponsableCompany & "||" & SM_idObra & "||" & SM_idBudgetArea & "||" & SM_idBudgetDetalle & "||AUT||" & session("MmtoDato") & "||" )
...
sub updateOtGenerated(pMasterOT, pGeneratedOT)
	call executeProcedureDb(DBSITE_SQL_INTRA, rs, "TBLSMOTEXECUTIONS_INS", pMasterOT & "||0||" & pGeneratedOT & "||S")
end sub
%>