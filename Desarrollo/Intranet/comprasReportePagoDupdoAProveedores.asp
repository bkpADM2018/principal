...
if (g_accion = ACCION_SUBMITIR) then	 
    ...
    g_fechaDesde = "1" & RIGHT(g_fechaDesdeA,2) & g_fechaDesdeM & g_fechaDesdeD
    g_fechaHasta = "1" & RIGHT(g_fechaHastaA,2) & g_fechaHastaM & g_fechaHastaD
	Select case (ret)
		case 0 
            Call loadReportPagoDuplicado (XLS_STREAM_MODE,g_fechaDesde,g_fechaHasta)
        case 1
...
<title>Reporte de Pagos Duplicados x Proveedor</title>
...
<form name="frmSel" id="frmSel" action="comprasReportePagoDupdoAProveedores.asp">
<div class="tableaside size100"> <!-- BUSCAR -->
    <h3> Reporte de pagos duplicados a proveedor </h3>
