...
if not rsHeaderOT.eof then
    ...
    'A partir de la primera ocurrencia para una OT planificada (repetitivo) su valor vendrá null, debido a que la unidad y la cantidad estarán asignadas a la OT maestra
