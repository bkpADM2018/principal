...
<script type="text/javascript">
	...
	function realizarConsulta(division, almacen, fecha){
		...
		ch.bind("almacenCC_ControlesContablesAjax.asp?idDivision=" + division + "&idAlmacen=" + almacen + "&fecha=" + fecha, "realizarConsultaCallback()");
		ch.send();			
	}
	...
	function verArtSinPrecio(pFecha, pIdCierre){
		ch.bind("almacenCC_ControlesContablesAjax.asp?idAlmacen=<%=idAlmacen%>&idDivision=<%=idDivision%>&fecha=" + pFecha, "realizarConsultaCallback()");
		ch.send();			
	}
</script>
</head>
