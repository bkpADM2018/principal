...
<div class="tableaside size100"> 
    ...
    <div class="tableasidecontent">
        ...
        <div class="col26 reg_header_navdos"> <% =GF_TRADUCIR("Descripción Abr.") %> </div>
        ...
        <div class="col26 reg_header_navdos"> <% =GF_TRADUCIR("Humedad recepción") %> </div>
        ...
        <div class="col26 reg_header_navdos"> <% =GF_TRADUCIR("Ultima boleta cámara") %> </div>
        ...
        <div class="col26 reg_header_navdos"> <% =GF_TRADUCIR("Código Cámara") %> </div>
        ...
        <div class="col26 reg_header_navdos"> <% =GF_TRADUCIR("Humedímetro") %> </div>
        <div class="col26">
        ...
        <div class="col26 reg_header_navdos"> <% =GF_TRADUCIR("Tipo de Envío") %> </div>
        <div class="col46">
			<input name="tipoEnvio" id="tipoEnvio" type="radio" value="<%=TIPO_ENVIO_ACEP_CONF_COND_CAMARA%>" <% if ((g_TipoEnvio <= TIPO_ENVIO_ACEP_CONF_COND_CAMARA)or(g_TipoEnvio="")) then Response.Write "checked" end if %>/><%=GF_TRADUCIR("Acep. Conf. y Cond. Cámara")%>			
			<input name="tipoEnvio" id="tipoEnvio" type="radio" value="<%=TIPO_ENVIO_COND_CAMARA%>" <% if (g_TipoEnvio = TIPO_ENVIO_COND_CAMARA) then Response.Write "checked" end if %>/><%=GF_TRADUCIR("Cond. Cámara solamente")%>
        </div>
        
        <div class="col26 reg_header_navdos"> <% =GF_TRADUCIR("Último turno") %> </div>
        <div class="col46">
...
<% if ((flagAdd)and(g_IsEdit))then %>
    ...
    <div class="tableaside size100"> 
	    <h3> <%=GF_Traducir("Biotecnologías")%> </h3>		
	    <div class="tableasidecontent">
