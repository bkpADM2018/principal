...
if (fso.FolderExists(valParameterPath)) then
	...
	if (strFileError = "") then			
		...
		if (auxDestino <> "") then Call enviarMailAnalisisCamara(auxDestino,strAtt,"Poseidon - Exportacion Analisis de Cámara", "Se generaron los archivos de analisis para la Cámara. Se adjuntan los mismos.")				
