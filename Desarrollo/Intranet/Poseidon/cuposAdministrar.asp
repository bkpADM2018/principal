...
%>
            ...
            <span class="btnaction">
                <input type="button" value="Finalizar Nominación y Obtener c&oacute;digos de cupo" onclick="javascript:verCupos(<%=myCuitCliente %>,'<% =myCdCorredor %>','','<%=fechaDesde %>','<%=fechaHasta %>')" ></input>
            </span>                   
<%          end if %>                 
        <% end if %>            
    </div>
