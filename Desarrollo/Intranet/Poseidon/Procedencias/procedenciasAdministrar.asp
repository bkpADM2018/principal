	...
	if (not rs.eof) then %>	
			<thead>
                <tr>
				    ...
				    <th><% =GF_TRADUCIR("Proc. Cámara") %>	</th>
				    <th><% =GF_TRADUCIR("Loc. Cámara") %>	</th>
				    <th><% =GF_TRADUCIR("Pcia. Cámara") %>	</th>
				    <th>.</th>
                </tr>
            </thead> 
				<tbody>
...
<%	end if	
		...
		<tr><td align="center"><%=GF_TRADUCIR("Ingrese la descripción de la procedencia a buscar")%></td></tr>
<%	
end if %>
</TABLE>
