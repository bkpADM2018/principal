...
<script type="text/javascript">
	...
	function bodyOnLoad() {
		...
		tb.addButton("Contabilidad_Folder-16x16.png", "Contabilidad Histórica", "irA('almacenContabilidad.asp')");
		tb.draw();		
	...
	function realizarConsultaCallback(){
		...
		link = "almacenFirmarAsientos.asp?idCierre=" + idCierre + "&secuencia=";
...
<% call GF_TITULO2("kogge64.gif","Administración Almacenes - Consultas Contables Históricas") %>
<div id="toolbar"></div>
<form id="frmSel">
...
<table align="center" align="center" width="90%" border="0">
	<tr>
		<td align="right">
			...
			if cdCuenta <> "" then
				if flagLink then
					strLink = "<img src='images/arrow_categ.gif'><a class='link' onclick='delObra()' title='" & cdCuenta & "'>" & cdCuenta & "</a>" & strLink
				else
					strLink = "<img src='images/arrow_categ.gif'><font title='" & cdCuenta & "'>" & cdCuenta & "</font>" 
					flagLink = true
				end if
			end if
