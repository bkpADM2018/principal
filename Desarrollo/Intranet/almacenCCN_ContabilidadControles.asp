...
<script type="text/javascript">
	...
	function fcnCall(seccion) {
		if (seccion == 0){
			location.href = "almacenCCN_ControlesContables.asp";
		} else if(seccion == 1) {
			location.href = "almacenCCN_ControlCruzadoContable.asp";
		} 
	}
	function bodyOnLoad() {
...
<% call GF_TITULO2("kogge64.gif","Administración - Controles Contables") %>
<div id="toolbar"></div>
<br>
