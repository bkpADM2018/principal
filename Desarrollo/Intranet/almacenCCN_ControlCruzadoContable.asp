...
<script type="text/javascript">
	...
	function realizarConsulta(division, almacen, fecha){
		...
		ch.bind("almacenCCN_ControlCruzadoContableAjax.asp?idDivision=" + division + "&idAlmacen=" + almacen + "&fecha=" + fecha, "realizarConsultaCallback()");
		ch.send();			
	}
	...
	function verCruzado(pFecha, pIdCierre){
		...
		ch.bind("almacenCCN_ControlCruzadoContableAjax.asp?idCierre=" + pIdCierre + "&idAlmacen=<%=idAlmacen%>&idDivision=<%=idDivision%>&fecha=" + pFecha, "realizarConsultaCallback()");
		ch.send();			
	}
</script>
</head>
